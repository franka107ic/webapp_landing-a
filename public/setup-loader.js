...
<div id="loader" style="display: flex; justify-content: center; align-items: center; background: rgba(255, 255, 255, 0.4); width: 100%; height: 100%; position: absolute;">
  <div id="loader-inner" style="position: fixed; left:0; top:0; z-index:10; width:100%; height:100%">
...
setTimeout(() => {
  ...
  if (window.LOTTIE_LOADER_DATA) {
    ...
    lottieAnimationData.path =
      "https://ic-projects-file-uploads.s3.us-east-2.amazonaws.com/702926627029266270292662/609984c1467c28000980c845";
  }
